...
void SiltEffect::setUpGeometries(unsigned int numParticles)
{
	...
	if (!_quadStateSet)
	{
		...
		program->addShader(osg::Shader::readShaderFile(osg::Shader::VERTEX, osgDB::findDataFile("resources/shaders/silt_quads.vert")));
		program->addShader(osg::Shader::readShaderFile(osg::Shader::FRAGMENT, osgDB::findDataFile("resources/shaders/silt_quads.frag")));
#endif
	}
...
#else
		// get shaders from source
		program->addShader(osg::Shader::readShaderFile(osg::Shader::VERTEX, osgDB::findDataFile("resources/shaders/silt_points.vert")));
		program->addShader(osg::Shader::readShaderFile(osg::Shader::FRAGMENT, osgDB::findDataFile("resources/shaders/silt_points.frag")));
#endif
